...
public class ProductDAL
{
    ...
    public virtual ProductCreationDAL? ProductCreation { get; set; }
    public virtual ICollection<ProductImageDAL>? ProductImages { get; set; }
    public virtual ICollection<ProductFileDAL>? ProductFiles { get; set; }
